# Given a grid of size m * n and robot is paced at n-1 and m-1 aloso given a string
# at str only the character of U, D , L , R representing the moves the robot is
